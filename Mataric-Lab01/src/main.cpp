...
int pauseTime = 5000;   //time before robot moves
...
void setup()
{
  ...
  //BTSerial.begin(BTbaud);     //start Bluetooth communication  UNCOMMENT to try Bluetooth -----------------------
  Serial.begin(baudrate);     //start serial monitor communication

  while (!Serial)
    delay(10); // will pause until serial console opens
  
 // init_BT(); //initialize Bluetooth     UNCOMMENT to try Bluetooth -----------------------

  //init_IMU(); //initialize IMU          UNCOMMENT to try Bluetooth -----------------------
